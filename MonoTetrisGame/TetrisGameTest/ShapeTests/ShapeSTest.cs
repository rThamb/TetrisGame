...
namespace TetrisGameTest.ShapeTests
{
    ...
    public class ShapeSTest
    {
        ...
        public void MoveLeftTest()
        {
            ...
            String expect = "";
            //only 3 valid time to move left 
            for (int i = 0; i < 6; i++)
            {
        ...
        public void MoveRightTest()
        {
            ...
            //only 4 valid time to move right 
            for (int i = 0; i < 6; i++)
            {
        ...
        public void RotateTest()
        {
            ...
            Point[] rotationSet = {
                                        new Point(0,0), // the origin block 
                                        new Point (-1,-1),
                                        new Point(1,-1),
                                        new Point (2,0)
                                    };
            ...
            String expected2 = calRotate(a, rotationSet2);
            ...
            String expected3 = calRotate(a, rotationSet3);
            ...
            Assert.AreEqual(expected3, a.ToString());
